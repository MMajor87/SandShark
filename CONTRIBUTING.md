# SandShark Contributing Guide

## Maintainer Authority

SandShark is maintained by its core maintainers.
...
SandShark is a Windows desktop client for compatible Sharkord servers. It builds on the upstream frontend and keeps the server and shared packages in this repository for compatibility and development.
...
## What SandShark Is Not

- **Not a Discord Clone**: We do not aim to replicate every Discord feature. SandShark is not intended to be a huge community platform or a knowledge base. We focus on core communication features, not feature parity with Discord.
...
- Explain why it fits SandShark’s scope
